...
ax1.scatter(discharge_data[0, :], discharge_data[2, :], color=color_red, s=0.5)
ax1.scatter(charge_data[0, :], charge_data[2, :], color=color_green, s=0.5)
...
ax3.set_title("OCV vs SOC (charg & discharge)")
ax3.set_xlabel('SOC')
